(function() {
    ...
    function playerCollision (collidingObj) {
        ...
        if (collidingObj.type === "WALL") {
            ...
            if(totalLife < 0) {
                ...
                //stop any touchscreen cont movement
                stopContinuousMovement();                
    ...
    * When a direction key is clicked make a continous movement on that
    ...
    ********************************************************************/
    ...
    $('#right-joystick .stop').on("touchstart", function () {
        stopContinuousMovement();
    });
    ...
    /*
    * Cancels the continuous movements
    * Unregisters from ticker
    * Resets the vars
    */
